...
/*****************************************************************************
  ...
  Примечание: работа механизма не протестирована при использовании множествен-
  ного и виртуального наследования.
  Статья посвященная тонкостям работы с указателями на функции члены класса
  при множественном и виртуальном наследовании:
