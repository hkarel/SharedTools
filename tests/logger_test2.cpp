...
#define log_error_m   alog::logger().error   (alog_line_location, "MainModule")
#define log_warn_m    alog::logger().warn    (alog_line_location, "MainModule")
#define log_info_m    alog::logger().info    (alog_line_location, "MainModule")
#define log_verbose_m alog::logger().verbose (alog_line_location, "MainModule")
#define log_debug_m   alog::logger().debug   (alog_line_location, "MainModule")
#define log_debug2_m  alog::logger().debug2  (alog_line_location, "MainModule")
